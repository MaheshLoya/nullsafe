...
/**
 * Criteria class for the {@link com.nullsafe.daily.domain.City} entity. This class is used
 * in {@link com.nullsafe.daily.web.rest.CityResource} to receive all the possible filtering options from
...
public class CityCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, deleted, distinct);
    }
