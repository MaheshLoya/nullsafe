...
public class Role implements Serializable {
    ...
    public void setAssignRoles(Set<AssignRole> assignRoles) {
        if (this.assignRoles != null) {
            this.assignRoles.forEach(i -> i.setRole(null));
        }
        if (assignRoles != null) {
            assignRoles.forEach(i -> i.setRole(this));
        }
        this.assignRoles = assignRoles;
    }

    public Role assignRoles(Set<AssignRole> assignRoles) {
        this.setAssignRoles(assignRoles);
        return this;
    }

    public Role addAssignRole(AssignRole assignRole) {
        this.assignRoles.add(assignRole);
        assignRole.setRole(this);
        return this;
    }

    public Role removeAssignRole(AssignRole assignRole) {
        this.assignRoles.remove(assignRole);
        assignRole.setRole(null);
        return this;
    }
