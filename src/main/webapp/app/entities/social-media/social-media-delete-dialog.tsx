...
export const SocialMediaDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/social-media' + pageLocation.search);
  };
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(socialMediaEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dailiesApp.socialMedia.delete.question">
        <Translate contentKey="dailiesApp.socialMedia.delete.question" interpolate={{ id: socialMediaEntity.id }}>
...
export default SocialMediaDeleteDialog;
