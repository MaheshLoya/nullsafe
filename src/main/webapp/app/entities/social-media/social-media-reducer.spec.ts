...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIALMEDIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOCIALMEDIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOCIALMEDIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOCIALMEDIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOCIALMEDIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOCIALMEDIA actions', async () => {
      const expectedActions = [
        {
