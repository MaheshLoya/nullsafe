...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEBAPPSETTINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_WEBAPPSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WEBAPPSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WEBAPPSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WEBAPPSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WEBAPPSETTINGS actions', async () => {
      const expectedActions = [
        {
