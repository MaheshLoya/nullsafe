...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './web-pages.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEBPAGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_WEBPAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WEBPAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WEBPAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WEBPAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WEBPAGES actions', async () => {
      const expectedActions = [
        {
