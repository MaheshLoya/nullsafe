...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './subscription-renewal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSCRIPTIONRENEWAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBSCRIPTIONRENEWAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBSCRIPTIONRENEWAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBSCRIPTIONRENEWAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBSCRIPTIONRENEWAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBSCRIPTIONRENEWAL actions', async () => {
      const expectedActions = [
        {
