...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PASSWORDRESETS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PASSWORDRESETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PASSWORDRESETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PASSWORDRESETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PASSWORDRESETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PASSWORDRESETS actions', async () => {
      const expectedActions = [
        {
