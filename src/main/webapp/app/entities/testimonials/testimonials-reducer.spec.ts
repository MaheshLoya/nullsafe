...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTIMONIALS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTIMONIALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTIMONIALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTIMONIALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTIMONIALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTIMONIALS actions', async () => {
      const expectedActions = [
        {
