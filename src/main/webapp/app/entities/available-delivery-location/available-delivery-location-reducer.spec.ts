...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './available-delivery-location.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AVAILABLEDELIVERYLOCATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_AVAILABLEDELIVERYLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AVAILABLEDELIVERYLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AVAILABLEDELIVERYLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AVAILABLEDELIVERYLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AVAILABLEDELIVERYLOCATION actions', async () => {
      const expectedActions = [
        {
