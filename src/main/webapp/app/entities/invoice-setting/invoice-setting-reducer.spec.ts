...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVOICESETTING_LIST actions', async () => {
    ...
    it('dispatches FETCH_INVOICESETTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INVOICESETTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INVOICESETTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INVOICESETTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INVOICESETTING actions', async () => {
      const expectedActions = [
        {
