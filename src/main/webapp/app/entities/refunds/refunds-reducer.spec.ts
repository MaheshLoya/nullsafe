...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './refunds.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REFUNDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_REFUNDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REFUNDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REFUNDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REFUNDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REFUNDS actions', async () => {
      const expectedActions = [
        {
