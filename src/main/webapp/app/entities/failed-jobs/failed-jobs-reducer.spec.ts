...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FAILEDJOBS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FAILEDJOBS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FAILEDJOBS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FAILEDJOBS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FAILEDJOBS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FAILEDJOBS actions', async () => {
      const expectedActions = [
        {
