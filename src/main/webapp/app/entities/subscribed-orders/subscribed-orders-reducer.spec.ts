...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './subscribed-orders.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSCRIBEDORDERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBSCRIBEDORDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBSCRIBEDORDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBSCRIBEDORDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBSCRIBEDORDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBSCRIBEDORDERS actions', async () => {
      const expectedActions = [
        {
