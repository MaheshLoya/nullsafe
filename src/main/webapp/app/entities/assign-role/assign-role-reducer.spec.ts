...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSIGNROLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ASSIGNROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASSIGNROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASSIGNROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASSIGNROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASSIGNROLE actions', async () => {
      const expectedActions = [
        {
