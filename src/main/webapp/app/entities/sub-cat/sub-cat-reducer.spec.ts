...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sub-cat.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBCAT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBCAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBCAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBCAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBCAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBCAT actions', async () => {
      const expectedActions = [
        {
