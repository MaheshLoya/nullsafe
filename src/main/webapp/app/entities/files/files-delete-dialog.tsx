...
export const FilesDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/files' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dailiesApp.files.delete.question">
        <Translate contentKey="dailiesApp.files.delete.question" interpolate={{ id: filesEntity.id }}>
