...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './personal-access-tokens.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSONALACCESSTOKENS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERSONALACCESSTOKENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERSONALACCESSTOKENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERSONALACCESSTOKENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERSONALACCESSTOKENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERSONALACCESSTOKENS actions', async () => {
      const expectedActions = [
        {
