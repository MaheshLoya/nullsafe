...
export const TransactionsDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/transactions' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dailiesApp.transactions.delete.question">
        <Translate contentKey="dailiesApp.transactions.delete.question" interpolate={{ id: transactionsEntity.id }}>
