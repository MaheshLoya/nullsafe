...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALLOWPINCODE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ALLOWPINCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ALLOWPINCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ALLOWPINCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ALLOWPINCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ALLOWPINCODE actions', async () => {
      const expectedActions = [
        {
