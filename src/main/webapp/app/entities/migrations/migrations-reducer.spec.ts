...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MIGRATIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_MIGRATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MIGRATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MIGRATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MIGRATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MIGRATIONS actions', async () => {
      const expectedActions = [
        {
