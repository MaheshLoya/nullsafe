...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANNERIMAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANNERIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANNERIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANNERIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANNERIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANNERIMAGE actions', async () => {
      const expectedActions = [
        {
