...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './specific-notification.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIFICNOTIFICATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPECIFICNOTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPECIFICNOTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPECIFICNOTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPECIFICNOTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPECIFICNOTIFICATION actions', async () => {
      const expectedActions = [
        {
