    ...
    <Row>
      <Col md="8">
        <h2 data-cy="cityDetailsHeading">
          <Translate contentKey="dailiesApp.city.detail.title">City</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="dailiesApp.city.title">Title</Translate>
            </span>
          </dt>
          ...
          <dd>{cityEntity.deleted ? 'true' : 'false'}</dd>
        </dl>
