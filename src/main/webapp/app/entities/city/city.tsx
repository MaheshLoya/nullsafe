  ...
  return (
    <div>
      <h2 id="city-heading" data-cy="CityHeading">
        <Translate contentKey="dailiesApp.city.home.title">Cities</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="dailiesApp.city.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/city/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="dailiesApp.city.home.createLabel">Create new City</Translate>
          </Link>
        </div>
      </h2>
        ...
        {cityList && cityList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="dailiesApp.city.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="dailiesApp.city.title">Title</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('title')} />
                </th>
                <th className="hand" onClick={sort('deleted')}>
                  <Translate contentKey="dailiesApp.city.deleted">Deleted</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="dailiesApp.city.home.notFound">No Cities found</Translate>
            </div>
          )
        )}
      </div>
