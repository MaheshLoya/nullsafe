...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './order-user-assign.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERUSERASSIGN_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERUSERASSIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERUSERASSIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERUSERASSIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERUSERASSIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERUSERASSIGN actions', async () => {
      const expectedActions = [
        {
