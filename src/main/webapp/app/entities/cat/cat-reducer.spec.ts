...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cat.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAT actions', async () => {
      const expectedActions = [
        {
