...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERNOTIFICATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERNOTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERNOTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERNOTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERNOTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERNOTIFICATION actions', async () => {
      const expectedActions = [
        {
