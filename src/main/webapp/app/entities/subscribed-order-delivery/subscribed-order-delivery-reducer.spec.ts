...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './subscribed-order-delivery.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSCRIBEDORDERDELIVERY_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBSCRIBEDORDERDELIVERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBSCRIBEDORDERDELIVERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBSCRIBEDORDERDELIVERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBSCRIBEDORDERDELIVERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBSCRIBEDORDERDELIVERY actions', async () => {
      const expectedActions = [
        {
