...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPSETTINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPSETTINGS actions', async () => {
      const expectedActions = [
        {
