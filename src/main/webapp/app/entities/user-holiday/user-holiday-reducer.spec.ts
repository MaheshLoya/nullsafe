...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERHOLIDAY_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERHOLIDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERHOLIDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERHOLIDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERHOLIDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERHOLIDAY actions', async () => {
      const expectedActions = [
        {
